...
<div id="quiz" x-data="lessonInstance()" class="pt-2">

	<div class="progress-container pt-3 d-flex align-items-center justify-content-between">
		<a href="{{ @BASE }}/lessons/{{ @lesson.course_id }}" class="btn btn-lg pt-1 pb-1 ps-0 me-2" type="button">
	...
	<div class="choice-container d-flex justify-content-center">
	...
	<div 
		...
		<div class="container h-100">
			<div class="row h-100 align-items-end justify-content-center">
				...
				<button class="btn btn-primary btn-lg btn-block mt-auto mb-4">EXIT</button>
			</div>
		</div>
	</div>
...
<!-- <img x-show="false" src="/kuku/assets/img/screenshot.jpg" width="400px"  class="mt-3">
-->
